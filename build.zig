...
pub fn build(b: *std.Build) void {
    ...
    const mod = b.addModule("poly1163", .{
    ...
    const exe = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            ...
            // root module.
            .imports = &.{
                // Here "poly1163" is the name you will use in your source code to
                // import this module (e.g. `@import("poly1163")`). The name is
                // repeated because you are allowed to rename your imports, which
                // can be extremely useful in case of collisions (which can happen
                // importing modules from different packages).
                .{ .name = "poly1163", .module = mod },
            },
        }),
    });
    ...
    const width_tests = b.addTest(.{
        .root_module = b.createModule(.{
            .root_source_file = b.path("src/test_width.zig"),
            .target = target,
            .optimize = optimize,
        }),
    });
